// not written
/* plan get product lists form processEdge
 * gather all products with type=product,raw material
*  gather only product type=semi product if its used here
*/
import {formSubmit} from '../../libs/utils'

export default function ProductsList({success, cancel}:{success:(...any:any[])=>void , cancel:Function} ){
